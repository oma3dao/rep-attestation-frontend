...
import { omachainTestnet, omachainMainnet, bscTestnet, bscMainnet, sepolia, mainnet, base } from '@/config/chains'
...
export function useWallet() {
  ...
  return {
    ...
    // Utilities
    supportedChainIds: [omachainTestnet.id, omachainMainnet.id, bscTestnet.id, bscMainnet.id, sepolia.id, mainnet.id, base.id]
  }
} 